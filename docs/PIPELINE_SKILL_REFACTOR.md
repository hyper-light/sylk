...
| **Pipeline protocol** (F) | `challenge_agent`, `handoff_next`, `validate_work`, `process_validation`, `discard_queued_artifacts`, `query_pipeline_state`; inspector: `finalize_pipeline`, `handoff_to_green`, `discard_pipeline`; tester: `finalize_pipeline` variant |
