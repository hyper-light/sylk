...
func TestDefaultSystemPrompt_IncludesStructuredMarkdownFormattingGuidance(t *testing.T) {
	for _, want := range []string{
		...
		"use `knowledge_query` early to search the knowledge graph and grounded document index",
		"`academic_forest_consult(purpose=get_authority_bundle, query=…)`",
		"`academic_forest_consult(purpose=check_contradictions, query=…)`",
