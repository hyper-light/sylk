---
name: academic-self-diagnostic
description: Diagnose recent academic failures and explain what happened, including input, attempted actions, and replay guidance. Use when the user says "you hit an error", "you crashed", "you seem stuck", or asks what failed and how to retry.
---
