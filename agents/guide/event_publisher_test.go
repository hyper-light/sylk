...
func TestNewGuideEventPublisher(t *testing.T) {
	...
	publisher := NewGuideEventPublisher(collector, "test-session")
...
func TestGuideEventPublisher_SessionID(t *testing.T) {
	...
	publisher := NewGuideEventPublisher(collector, "my-session")
...
func TestGuideEventPublisher_PublishUserPrompt(t *testing.T) {
	...
	publisher := NewGuideEventPublisher(collector, "default-session")
