...
func sectionGlobalShortcuts() Section {
	return Section{
		...
		Bindings: []Binding{
			...
			{"Alt+Shift+Right", "Move focus right (cycles sub-panels then next panel)", ""},
			{"Alt+Shift+Left", "Move focus left (cycles sub-panels then prev panel)", ""},
			{"Alt+Shift+Up", "Move focus up (sub-panel or previous row)", ""},
			{"Alt+Shift+Down", "Move focus down (sub-panel or next row)", ""},
		},
	}
}
...
func sectionEditMode() Section {
	return Section{
		...
		Bindings: []Binding{
			...
			{"Alt+Enter", "Dismiss preview / close tab", "Edit mode active and Edit panel focused"},
			...
			{"Alt+f", "Toggle find bar", "Edit mode and Edit panel focused"},
			...
			{"Alt+Shift+e", "Toggle between Explorer and editor", "Edit mode active"},
			...
			{"Alt+Shift+\\", "Vertical split", "Edit mode active and Edit panel focused"},
			{"Alt+Shift+-", "Horizontal split", "Edit mode active and Edit panel focused"},
			{"Alt+Shift+w", "Close focused pane", "Edit mode active with split panes"},
			{"Alt+]", "Grow focused pane", "Edit mode active with split panes"},
			{"Alt+[", "Shrink focused pane", "Edit mode active with split panes"},
			{"Alt+=", "Equalize split ratios", "Edit mode active with split panes"},
		},
	}
}
