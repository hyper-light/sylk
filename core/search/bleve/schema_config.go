...
func defaultFieldMappingConfigs() []FieldMappingConfig {
	return []FieldMappingConfig{
		...
		{Name: "content", Type: FieldTypeText, Analyzer: "code", Store: true, Index: true, IncludeInAll: false},
		{Name: "symbols", Type: FieldTypeText, Analyzer: "symbol", Store: true, Index: true, IncludeInAll: false},
		{Name: "comments", Type: FieldTypeText, Analyzer: "comment", Store: true, Index: true, IncludeInAll: false},
