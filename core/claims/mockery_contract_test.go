...
func claimsInfrastructureMockerySpecs() []claimsMockerySpec {
	...
	specs := []claimsMockerySpec{
		...
		{claimsPackage, "core/claims", "core/claims/mocks", "PendingContinuationRecoverer", "PendingContinuationRecoverer"},
		{claimsPackage, "core/claims", "core/claims/mocks", "ClaimWorkCanceller", "ClaimWorkCanceller"},
		{claimsPackage, "core/claims", "core/claims/mocks", "ShutdownScope", "ShutdownScope"},
		{claimsPackage, "core/claims", "core/claims/mocks", "ShutdownInbox", "ShutdownInbox"},
		{claimsPackage, "core/claims", "core/claims/mocks", "ShutdownContinuationStore", "ShutdownContinuationStore"},
...
func assertGeneratedMockHeader(t *testing.T, encodedFile string) {
	...
	if !strings.HasPrefix(body, "// Code generated by mockery") || !strings.Contains(firstLine(body), "DO NOT EDIT.") {
