...
func expectedSchemaHash() string {
	tables := []string{
		...
		"forest_antigenic_vectors",
		"forest_immunity_vectors",
		"forest_outbreaks",
		"forest_cursors",
		"forest_policies",
		"forest_policy_candidates",
		"forest_policy_trials",
		"forest_policy_outcomes",
		"forest_memes",
		"forest_meme_sources",
		"forest_meme_lineage",
		"forest_meme_fitness",
		"forest_meme_candidates",
		"forest_skill_candidates",
		"forest_skill_candidate_files",
		"forest_skill_candidate_validations",
		"forest_governance_proposals",
		"forest_governance_approvals",
	...
	triggers := []string{
		...
		"forest_cursors_no_update",
		"forest_cursors_no_delete",
	}
	indexes := []string{
		...
		"idx_forest_antigenic_scope",
		"idx_forest_antigenic_source",
		"idx_forest_immunity_scope",
		"idx_forest_immunity_source",
		"idx_forest_outbreaks_cluster",
		"idx_forest_outbreaks_status",
		"idx_forest_cursors_session",
		"idx_forest_cursors_agent",
		"idx_forest_policies_status",
		"idx_forest_policies_single_active",
		"idx_forest_policy_candidates_status",
		"idx_forest_policy_candidates_parent",
		"idx_forest_policy_trials_candidate",
		"idx_forest_policy_trials_cohort",
		"idx_forest_policy_outcomes_candidate",
		"idx_forest_policy_outcomes_policy",
		"idx_forest_memes_status",
		"idx_forest_memes_signature",
		"idx_forest_meme_sources_ref",
		"idx_forest_meme_lineage_child",
		"idx_forest_meme_fitness_score",
		"idx_forest_meme_candidates_status",
		"idx_forest_skill_candidates_status",
		"idx_forest_skill_candidates_role",
		"idx_forest_skill_candidate_files_hash",
		"idx_forest_skill_candidate_validations_candidate",
		"idx_forest_governance_proposals_status",
		"idx_forest_governance_proposals_claim",
		"idx_forest_governance_approvals_scope",
		"idx_forest_governance_quarantine_subject",
		"idx_forest_migration_slices_status",
		"idx_forest_legacy_archives_object",
