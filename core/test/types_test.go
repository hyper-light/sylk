...
func TestTestFrameworkIDConstants(t *testing.T) {
	tests := []struct {
		...
		{"FrameworkPythonUnitTest", FrameworkPythonUnitTest, "python-unittest"},
		...
		{"FrameworkBunTest", FrameworkBunTest, "bun-test"},
		{"FrameworkNodeTest", FrameworkNodeTest, "node-test"},
		{"FrameworkPHPUnit", FrameworkPHPUnit, "phpunit"},
		{"FrameworkJUnit", FrameworkJUnit, "junit"},
		{"FrameworkMavenTest", FrameworkMavenTest, "maven-test"},
		{"FrameworkGradleTest", FrameworkGradleTest, "gradle-test"},
		{"FrameworkSBTTest", FrameworkSBTTest, "sbt-test"},
		{"FrameworkMillTest", FrameworkMillTest, "mill-test"},
		{"FrameworkNUnit", FrameworkNUnit, "nunit"},
		{"FrameworkDotNetTest", FrameworkDotNetTest, "dotnet-test"},
		{"FrameworkCTest", FrameworkCTest, "ctest"},
		{"FrameworkSwiftTest", FrameworkSwiftTest, "swift-test"},
		{"FrameworkZigTest", FrameworkZigTest, "zig-test"},
		{"FrameworkDartTest", FrameworkDartTest, "dart-test"},
		{"FrameworkExUnit", FrameworkExUnit, "exunit"},
		{"FrameworkRebar3EUnit", FrameworkRebar3EUnit, "rebar3-eunit"},
		{"FrameworkStackTest", FrameworkStackTest, "stack-test"},
		{"FrameworkCabalTest", FrameworkCabalTest, "cabal-test"},
	}
